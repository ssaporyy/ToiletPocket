...
class PlacesService{
  final key = 'AIzaSyAvRknAjBrBfPCXrBTeNYJ8j8g6Fq32frQ';

  Future<List<PlaceSearch>> getAutocomplete(String search) async{
    var url = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$search&types=(cities)&key=AIzaSyAvRknAjBrBfPCXrBTeNYJ8j8g6Fq32frQ';
    var reponse = await http.get(url);
    var json = convert.jsonDecode(reponse.body);
    var jsonResults = json['predirections'] as List;
