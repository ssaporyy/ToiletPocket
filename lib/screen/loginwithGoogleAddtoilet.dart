...
class LoginGoogleAddToilet extends StatefulWidget {
  @override
  LoginGoogleAddToiletState createState() => LoginGoogleAddToiletState();
}

class LoginGoogleAddToiletState extends State<LoginGoogleAddToilet> {
